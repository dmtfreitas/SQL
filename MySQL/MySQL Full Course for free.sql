...
-- DESCARTAR E DESFAZER AS ALTERAÇÕES
ROLLBACK;
...
-- ALTERAR TABELA E ADICIONAR CONSTRAINT DO TIPO UNIQUE
...
-- INSERIR DADOS EM UMA LINHA DE TODAS AS COLUNAS DE UMA TABELA
INSERT INTO products
VALUE (100, "hamburguer", 3.99);

-- ALTERAR TABELA E MODIFICAR O TIPO DE DADO DE UMA COLUNA
ALTER TABLE products
MODIFY price DECIMAL(4,2) NOT NULL;

-- INSERIR DADOS EM UMA LINHA DE TODAS AS COLUNAS DE UMA TABELA COM PARÂMETRO NULL
INSERT INTO products
VALUE (104, "chicken", NULL);
